...
<body>
	...
	<section id="contentAdopt" class="flexContainer">
        ...
        <section id="howToAdoptArea">
            ...
            <section id="steps">   
                <section class="step">
                    <img src="app/style/img/iconAdopt.png"  title="Header Adoção" class="imgStep">
                    <section>
                        <h3>1. O desejo de Adotar:</h3>
                        <p>
                ...
                <section class="step">
                    <section>
                        <h3>2. A entrada nos Documentos:</h3>
                        <p>
                    ...
                    <img src="app/style/img/iconDocs.png" class="imgStep">
                </section>
                <section class="step">
                    <section>
                        <h3>3. Avaliação da equipe multidisciplinar do Judiciário:</h3>
                        <p>Essa etapa é muito importante, pois os postulantes à adoção serão avaliados por uma equipe multidisciplinar do Poder Judiciário.</p>
                        <p>Para que serve essa avaliação:</p>
                        <p> - Entender quais os motivos que levaram essas pessoas a querer adotar e quais são suas expectativas;</p>
                        <p> - Analisar qual é a realidade sociofamiliar dos adotantes;</p>
                        <p> - Identificar se os postulantes à adoção têm realmente condições de receber uma criança na condição de filho. E aqui vale a ressalva, não se trata apenas de questão financeira, mas saber se estão preparados emocionalmente, psicologicamente para exercerem essa maternidade / paternidade;</p>
                        <p> - Identificar na dinâmica familiar, qual o papel que esse filho ocupará;</p>
                        <p> - Orientar os adotantes sobre todo o processo adotivo.</p>
                    </section>
                </section>
                <section class="step">
                    <section>
                        <h3>4. Participação no Programa de Preparação para Adoção:</h3>
                        <p>A participação nesse curso é um requisito legal para todos aqueles que querem se habilitar no cadastro para adoção, e está disciplinado no Estatuto da Criança e do Adolescente.</p>
                        <p>Quais os objetivos desse curso?</p>
                        <p>- Entender melhor o processo de adoção;</p>
                        <p>- Auxiliar os postulantes quanto a clareza e a segurança na decisão de adotar;</p>
                        <p>- Auxiliar os postulantes a superarem os desafios e possíveis dificuldades que podem haver na convivência inicial com a criança / adolescente;</p>
                        <p>- Orientar e incentivar a adoção inter-racial, de crianças com deficiência, com doenças crônicas ou com necessidades específicas de saúde, além de grupos de irmãos.</p>
                    </section>
                </section>
                <section class="step">
                    <section>
                        <h3>5. Análise do requerimento:</h3>
                        <p>
                ...
                <section class="step">
                <img src="app/style/img/iconSearch.png" class="imgStep">
                    <section>
                        <h3>6. Busca de uma família para a criança / adolescente:</h3>
                        <p>
                ...
                <section class="step">
                    <section>
                        <h3>7. É hora de construir uma relação familiar:</h3>
                        <p>
                ...
                <section class="step">
                    <section>
                        <h3>8. Nasce uma nova família:</h3>
                        <p>
                    ...
                    <img src="app/style/img/iconFamily.png" class="imgStep">
                </section>
            </section>
        </section>
    </section>
